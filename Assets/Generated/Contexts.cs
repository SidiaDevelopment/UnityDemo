...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, string>(
            Placeable,
            game.GetGroup(GameMatcher.Placeable),
            (e, c) => ((PlaceableComponent)c).Name));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithPlaceable(this GameContext context, string Name) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, string>)context.GetEntityIndex(Contexts.Placeable)).GetEntity(Name);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
